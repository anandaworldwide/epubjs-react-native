...
export type Flow = 'auto' | 'paginated' | 'scrolled' | 'scrolled-doc' | 'scrolled-continuous';
...
export interface ReaderProps {
     ...
     * @returns {void} void
     */
    onReady?: (totalLocations: number, currentLocation: Location, progress: number) => void;
    /**
     ...
     * @returns {void} void
     */
    onLocationChange?: (totalLocations: number, currentLocation: Location, progress: number, currentSection: Section | null) => void;
    /**
    ...
    getInjectionJavascriptFn?: (injectJavascript: (script: string) => void) => void;
