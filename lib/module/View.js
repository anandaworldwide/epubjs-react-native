...
export function View({
  ...
  const lastInternalLinkPressTime = useRef(0);
  ...
  return /*#__PURE__*/React.createElement(GestureHandler, {
    width: width,
    height: height,
    onSingleTap: () => {
  ...
  }, renderOpeningBookComponent()), /*#__PURE__*/React.createElement(WebView, {
    ref: book,
    source: {
      uri: templateUri
    },
