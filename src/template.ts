...
<!DOCTYPE html>
  ...
  <body oncopy='return false' oncut='return false'>
    ...
    <script>
      ...
      // Click handler function for internal links
      function internalLinkClickHandler(e) {
      ...
      function attachClickHandler(doc) {
        ...
        doc.addEventListener('click', internalLinkClickHandler, true);
      }
      ...
      function ensureClickHandlersOnAllViews() {
        ...
        rendition.getContents().forEach(function(content) {
          attachClickHandler(content.document);
        });
        ...
        if (views && views.length) {
          views.forEach(function(view) {
            if (view && view.document) {
              attachClickHandler(view.document);
            }
          });
        }
      }
